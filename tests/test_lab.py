    ...
    def test_list_all_targets_single_page(self, mock_env: None, clear_client_cache: None) -> None:
        respx.get(f"{BASE_URL}/targets").mock(
            return_value=Response(
                ...
                json={
                    "items": [
                        {"id": "t1", "name": "Target 1", "vendor_name": "V", "catalog_number": "C1", "url": "https://catalog.example.com/t1"},
                        {"id": "t2", "name": "Target 2", "vendor_name": "V", "catalog_number": "C2", "url": "https://catalog.example.com/t2"},
                    ],
                    "total": 2,
                    "count": 2,
                    "offset": 0,
    ...
    def test_list_all_targets_multiple_pages(
        ...
        respx.get(f"{BASE_URL}/targets", params={"limit": "2", "offset": "2"}).mock(
            return_value=Response(
                ...
                json={
                    "items": [
                        {"id": "t3", "name": "Target 3", "vendor_name": "V", "catalog_number": "C3", "url": "https://catalog.example.com/t3"},
                    ],
                    "total": 3,
                    "count": 1,
                    "offset": 2,
